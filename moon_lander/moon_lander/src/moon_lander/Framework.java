    ...
    public void Draw(Graphics2D g2d)
    {
        switch (gameState)
        {
            ...
            case MAIN_MENU:
                ...
                g2d.drawString("Use arrow key to controle the rocket.", frameWidth / 2 - 117, frameHeight / 2);
                g2d.drawString("Press Q to start the game in easy mode.", frameWidth / 2 - 100, frameHeight / 2 + 30);
                g2d.drawString("Press W key to start the game in medium mode.", frameWidth / 2 - 100, frameHeight / 2 + 50);
                g2d.drawString("Press E key to start the game in hard mode.", frameWidth / 2 - 100, frameHeight / 2 + 70);
